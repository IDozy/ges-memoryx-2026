...
import { RegistroRow } from "@/src/components/record/types";
import { getRegistroColumns } from "@/src/components/record/recordColumns";
...
export default function RegistroTable({
  ...
  const columns = useMemo(() => getRegistroColumns(), []);
        ...
        <div className="flex flex-col gap-3 sm:flex-row sm:items-center">
          <div className="relative w-full sm:max-w-md">
            <input
              ...
              placeholder="Buscar por nombre, teléfono, grado, taller, tutor..."
